(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    ((j.constructor = w), v(j, x.prototype), (j.isPureReactComponent = !0));
    var E = Array.isArray;
    function S() {}
        ...
        !(function e(t, r, n, a, i) {
          ...
          if (E(t))
            ...
            for (t = h.call(t), h = 0; !(a = t.next()).done; )
              ((f = p + C((a = a.value), h++)), (d += e(a, r, n, f, i)));
          else if ('object' === f) {
  ...
  (e) => {
    'use strict';
    e.s(['WidgetGamesFlipism', () => n], 86636);
    var t = e.i(94601),
      r = e.i(36960);
    let n = () => {
      let [e, n] = (0, r.useState)(!1),
        [o, u] = (0, r.useState)('Heads or Tails');
      return (0, t.jsx)('div', {
        className:
        ...
        children: (0, t.jsx)('div', {
          ...
          children: (0, t.jsx)('button', {
            ...
            children: e ? 'Spinning' : o,
          }),
        }),
      });
    };
    e.s(['WidgetGamesRockPaperScissors', () => u], 47162);
    var o = e.i(66709);
    let u = () => {
      let [e, n] = (0, r.useState)(0),
        [u, a] = (0, r.useState)(0);
      (0, r.useEffect)(() => {
        if (e <= 0) return void a(Math.floor(2 * Math.random()));
        let t = setInterval(() => {
          n((e) => e - 1);
        }, 1e3);
      ...
      let i = [
        (0, t.jsx)(o.FaHandFist, { className: 'text-9xl' }, 'rock'),
        (0, t.jsx)(o.FaHand, { className: 'text-9xl' }, 'paper'),
        (0, t.jsx)(o.FaHandPeace, { className: 'text-9xl' }, 'scissors'),
      ];
      return (0, t.jsx)('div', {
        className:
          'shadow-3xl relative aspect-square w-full max-w-60 overflow-hidden rounded-full bg-neutral-900 text-neutral-100',
    ...
    e.s(['WidgetGamesWheelOfFortune', () => a], 73905);
    let a = () => {
      let [e, n] = (0, r.useState)(0),
        [o, u] = (0, r.useState)(!1);
      return (
          ...
          children: [
            (0, t.jsx)('div', {
              ...
              children: (0, t.jsx)('div', {
                ...
                children: (0, t.jsx)(n.WidgetGamesRockPaperScissors, {}),
              }),
            }),
            (0, t.jsx)('div', {
              className: 'col-span-1',
              children: (0, t.jsx)('div', {
                className: 'flex h-full items-center justify-center',
                children: (0, t.jsx)(r.WidgetGamesFlipism, {}),
              }),
            }),
            (0, t.jsx)('div', {
              className: 'col-span-1',
              children: (0, t.jsx)('div', {
                className: 'flex h-full items-center justify-center',
                children: (0, t.jsx)(o.WidgetGamesWheelOfFortune, {}),
              }),
            }),
          ],
        }),
  ...
  (e, t, r) => {
    let n = '/games';
    ((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(84452)]),
      t.hot &&
