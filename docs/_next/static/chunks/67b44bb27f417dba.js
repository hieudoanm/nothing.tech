(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    ((j.constructor = E), _(j, b.prototype), (j.isPureReactComponent = !0));
    var x = Array.isArray;
    function S() {}
        ...
        !(function e(t, r, n, i, s) {
          ...
          if (x(t))
            ...
            for (t = h.call(t), h = 0; !(i = t.next()).done; )
              ((f = d + N((i = i.value), h++)), (p += e(i, r, n, f, s)));
          else if ('object' === f) {
  ...
  (e) => {
    ...
    let n = () => {
      let e = [
        ...
        8,
        9,
        (0, t.jsx)(r.FaMinus, {}, 'contacts'),
        (0, t.jsx)(r.FaEquals, {}, 'equals'),
        0,
        ',',
        (0, t.jsx)(r.FaPlus, {}, 'phone'),
      ];
      return (0, t.jsx)('div', {
        className:
  ...
  (e) => {
    ...
    let n = () =>
      (0, t.jsx)('div', {
        className:
          'h-screen w-screen overflow-hidden bg-neutral-100 md:h-screen',
        children: (0, t.jsx)('div', {
          className: 'flex h-full w-full items-center justify-center',
          children: (0, t.jsx)(r.WidgetCalculatorBasic, {}),
        }),
      });
  },
  85113,
  (e, t, r) => {
    let n = '/calculator';
    ((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(13325)]),
      t.hot &&
