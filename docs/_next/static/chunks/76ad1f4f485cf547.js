(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (c) => {
    ...
    var t = c.i(36960),
      ...
      a = t.default.createContext && t.default.createContext(l),
      r = ['attr', 'size', 'title'];
    function i() {
    ...
    function h(c) {
      var s = (l) => {
        var a,
          ...
          o = (function (c, t) {
            ...
            if (Object.getOwnPropertySymbols) {
              ...
              for (a = 0; a < i.length; a++)
                ((l = i[a]),
                  !(t.indexOf(l) >= 0) &&
                    Object.prototype.propertyIsEnumerable.call(c, l) &&
                    (r[l] = c[l]));
            }
            return r;
          })(c, r),
          d = n || l.size || '1em';
        return (
          l.className && (a = l.className),
          c.className && (a = (a ? a + ' ' : '') + c.className),
          t.default.createElement(
            'svg',
            i(
              {
              ...
              {
                className: a,
                style: e(e({ color: c.color || l.color }, l.style), c.style),
                height: d,
                width: d,
                xmlns: 'http://www.w3.org/2000/svg',
              }
            ),
            h && t.default.createElement('title', null, h),
            c.children
          )
        );
      };
      return void 0 !== a
        ? t.default.createElement(a.Consumer, null, (c) => s(c))
        : s(l);
    }
    function o(c) {
      return n({
