(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    ((E.constructor = w), g(E, _.prototype), (E.isPureReactComponent = !0));
    var j = Array.isArray;
    function S() {}
        ...
        !(function e(t, r, n, i, s) {
          ...
          if (j(t))
            ...
            for (t = h.call(t), h = 0; !(i = t.next()).done; )
              ((f = p + C((i = i.value), h++)), (d += e(i, r, n, f, s)));
          else if ('object' === f) {
  ...
  (e) => {
    'use strict';
    e.s(['WidgetMapsCoordinates', () => u], 54294);
    var t = e.i(94601),
      r = e.i(36960);
    let n = () => {
    ...
    var o = e.i(66709);
    let u = () => {
      let { latitude: e = 0, longitude: r = 0 } = n();
      return (0, t.jsx)('div', {
        className:
            ...
            children: [
              ...
              (0, t.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, t.jsxs)('p', {
                    children: [null == r ? void 0 : r.toFixed(2), '°'],
                  }),
                ],
              }),
            ],
    ...
    let i = () => {
      let { latitude: e = 0, longitude: r = 0 } = n(),
        o = parseFloat((null != r ? r : 0).toFixed(1)) - 0.1,
        u = parseFloat((null != r ? r : 0).toFixed(1)) + 0.1,
        i = parseFloat((null != e ? e : 0).toFixed(1)) + 0.1,
        s = parseFloat((null != e ? e : 0).toFixed(1)) - 0.1;
      return (0, t.jsx)('div', {
        className:
          ...
          children: [
            (0, t.jsx)('div', {
              ...
              children: (0, t.jsx)('div', {
                ...
                children: (0, t.jsx)(r.WidgetMapsCoordinates, {}),
              }),
            }),
            (0, t.jsx)('div', {
              className: 'col-span-1',
              children: (0, t.jsx)('div', {
                className: 'flex h-full items-center justify-center',
                children: (0, t.jsx)(n.WidgetMapsEmbedded, {}),
              }),
            }),
          ],
        }),
  ...
  (e, t, r) => {
    let n = '/maps';
    ((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(54855)]),
      t.hot &&
