(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    ((j.constructor = x), _(j, b.prototype), (j.isPureReactComponent = !0));
    var E = Array.isArray;
    function S() {}
  ...
  (e, t, r) => {
    ...
    function a(t) {
      ...
      if ('undefined' != typeof window) r = window.location.hostname;
        ...
        let { getRequestMeta: t } = e.r(14590),
          o = t(n, 'initURL');
  ...
  (e, t, r) => {
    let n = '/_error';
    ((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(53544)]),
      t.hot &&
  ...
  48858,
  (e) => {
    e.v((e) => Promise.resolve().then(() => e(25894)));
  },
  73489,
  (e) => {
    e.v((t) =>
